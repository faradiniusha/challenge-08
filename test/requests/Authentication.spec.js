...
describe("test api handleRegister", () => {
    it("return 201 OK", async () => {
      const name = "faradini";
      const email = `usha${Math.random().toString().substring(12)}@gmail.com`;
      const password = "sukses";
  ...
  describe("test api handleLogin", () => {
    it("return 201 OK", async () => {
      const email = "faradini@gmail.com";
      const password = "sukses";
    ...
    it("return 404! (Not Registered)", async () => {
      const email = "setyaputri@gmail.com";
      const password = "4567";
